                ...
                <div class="container-fluid">
                    ...
                    <div class="row top-buffer">
                        ...
                        <ol>
                            ...
                            <br />
                            <p>-l : Specifies Netcat to listen for an incoming connection. (can not be used with: -s, -p and -z)</p>
                            <p>-v : Specifies Netcat to give more verbose output.</p>
                            <p>-p : Specifies the source port.</p>
                            <p>-w : Specifies a timeout period.</p>
                        </ol>
